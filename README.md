...
- Seleccionar “Open in Colab” (o pegar la URL del notebook en https://colab.research.google.com).
...
- Descargar o clonar el repositorio: git clone https://github.com/tu-usuario/telecom-churn-analysis.git
